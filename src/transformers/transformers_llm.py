...
model = AutoModelForCausalLM.from_pretrained(parser.model,cache-dir=args.cache_dir)
tokenizer = AutoTokenizer.from_pretrained(parser.model,cache-dir=args.cache_dir)
...
text_generation_pipeline = pipeline(
    ...
    repetition_penalty=parser.repetition_penalty,  
)
